...
# Scenario 4: Indicator encoding missingness handling
#
# Emma Tarmey
#
# Started:          06/10/2025
...
simulation_results_MNAR <- run_indicator_encoding_simulation(n_scenario = n_scenario,
                                                             n_obs      = n_obs,
                                                             n_rep      = n_rep,
...
simulation_results_MCAR <- run_indicator_encoding_simulation(n_scenario = n_scenario,
                                                             n_obs      = n_obs,
                                                             n_rep      = n_rep,
...
simulation_results_MAR <- run_indicator_encoding_simulation(n_scenario = n_scenario,
                                                            n_obs      = n_obs,
                                                            n_rep      = n_rep,
