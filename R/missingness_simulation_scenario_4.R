...
# Scenario 4: Bootstrap MI with normally distributed confounders Z_i
#
# Emma Tarmey
#
# Started:          06/10/2025
...
missingness_handling <- "bootstrap_MI"
...
stop("TODO: Finish bootstrap MI")

# bootstrap MI
source("missingness_simulation_method_bootstrap_MI.R")
simulation_results <- run_bootstrap_MI_simulation(n_scenario = n_scenario,
                                                  n_obs      = n_obs,
                                                  n_rep      = n_rep,
