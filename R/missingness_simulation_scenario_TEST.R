...
using("bootImpute", "dplyr", "glmnet", "mice", "mlmi", "speedglm", "tidyr")
...
source("missingness_simulation_method_MLMI.R")
simulation_results <- run_MLMI_simulation(n_scenario = n_scenario,
                                          n_obs      = n_obs,
                                          n_rep      = n_rep,
