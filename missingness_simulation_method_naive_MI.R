...
run_naive_MI_simulation <- function(n_scenario = NULL,
  ...
  for (repetition in c(1:n_rep)) {
    ...
    handled_MNAR_list_of_datasets <- list(complete(handled_MNAR_dataset, action = 1),
                                          ...
                                          complete(handled_MNAR_dataset, action = 6),
                                          complete(handled_MNAR_dataset, action = 7),
                                          complete(handled_MNAR_dataset, action = 8),
                                          complete(handled_MNAR_dataset, action = 9),
                                          complete(handled_MNAR_dataset, action = 10),
                                          complete(handled_MNAR_dataset, action = 11),
                                          complete(handled_MNAR_dataset, action = 12),
                                          complete(handled_MNAR_dataset, action = 13),
                                          complete(handled_MNAR_dataset, action = 14),
                                          complete(handled_MNAR_dataset, action = 15),
                                          complete(handled_MNAR_dataset, action = 16),
                                          complete(handled_MNAR_dataset, action = 17),
                                          complete(handled_MNAR_dataset, action = 18),
                                          complete(handled_MNAR_dataset, action = 19),
                                          complete(handled_MNAR_dataset, action = 20))
    ...
    handled_MCAR_list_of_datasets <- list(complete(handled_MCAR_dataset, action = 1),
                                          ...
                                          complete(handled_MCAR_dataset, action = 6),
                                          complete(handled_MCAR_dataset, action = 7),
                                          complete(handled_MCAR_dataset, action = 8),
                                          complete(handled_MCAR_dataset, action = 9),
                                          complete(handled_MCAR_dataset, action = 10),
                                          complete(handled_MCAR_dataset, action = 11),
                                          complete(handled_MCAR_dataset, action = 12),
                                          complete(handled_MCAR_dataset, action = 13),
                                          complete(handled_MCAR_dataset, action = 14),
                                          complete(handled_MCAR_dataset, action = 15),
                                          complete(handled_MCAR_dataset, action = 16),
                                          complete(handled_MCAR_dataset, action = 17),
                                          complete(handled_MCAR_dataset, action = 18),
                                          complete(handled_MCAR_dataset, action = 19),
                                          complete(handled_MCAR_dataset, action = 20))
